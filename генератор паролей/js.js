...
const passwordField = document.querySelector('passwordField');
    ...
    avigator.clipboard.writeText(password)
        .then(() => {
...
//mainEl.appendChild(passwordField);


//привет тем кто читает 

// надо в блоке с alert поменять название функции которая там стоит на функцию который генерирует пароль спасибо